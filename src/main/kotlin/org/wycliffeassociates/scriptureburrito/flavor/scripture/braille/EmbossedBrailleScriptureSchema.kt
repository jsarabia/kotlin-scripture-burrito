package org.wycliffeassociates.scriptureburrito.flavor.scripture.braille
...
class EmbossedBrailleScriptureSchema {
    ...
    private var conventions: org.wycliffeassociates.scriptureburrito.flavor.scripture.Conventions? = null
    ...
    @JsonProperty("conventions")
    fun getConventions(): org.wycliffeassociates.scriptureburrito.flavor.scripture.Conventions? {
        return conventions
    }

    @JsonProperty("conventions")
    fun setConventions(conventions: org.wycliffeassociates.scriptureburrito.flavor.scripture.Conventions) {
